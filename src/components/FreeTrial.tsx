...
const FreeTrial = (props: Props) => {
  return (
    <div className="relative mx-auto mb-[20%] w-[90%] md:mb-[10%] md:w-[84%] lg:mb-[8%] lg:h-[344px] h-[40vh]">
      <Image
      ...
      />
      <div className="absolute top-[15%] h-[100%] w-[100%] items-center justify-between text-center lg:flex lg:right-12">
        <div className="md:mx-[7%]">
          <h2 className="mb-[10px] text-[28px] text-white lg:text-[48px] lg:text-start">
